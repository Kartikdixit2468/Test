...
.method private a(Landroid/content/Context;Lr/e;)Landroidx/emoji2/text/e$c;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroidx/emoji2/text/i;-><init>(Landroid/content/Context;Lr/e;)V
...
.method private d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lr/e;
    .locals 3
    ...
    invoke-direct {v1, v0, p1, v2, p2}, Lr/e;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)V
...
.method public c(Landroid/content/Context;)Landroidx/emoji2/text/e$c;
    ...
    .line 1
    invoke-virtual {p0, p1}, Landroidx/emoji2/text/c$a;->h(Landroid/content/Context;)Lr/e;

    move-result-object v0

    invoke-direct {p0, p1, v0}, Landroidx/emoji2/text/c$a;->a(Landroid/content/Context;Lr/e;)Landroidx/emoji2/text/e$c;
...
.method h(Landroid/content/Context;)Lr/e;
    .locals 2
    ...
    invoke-static {p1, v0}, Ls/g;->g(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, v0, p1}, Landroidx/emoji2/text/c$a;->d(Landroid/content/pm/ProviderInfo;Landroid/content/pm/PackageManager;)Lr/e;
