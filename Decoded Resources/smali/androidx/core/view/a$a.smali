...
.method public getAccessibilityNodeProvider(Landroid/view/View;)Landroid/view/accessibility/AccessibilityNodeProvider;
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/a;->b(Landroid/view/View;)Lt/u;

    move-result-object p1

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lt/u;->a()Ljava/lang/Object;
...
.method public onInitializeAccessibilityNodeInfo(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-static {p2}, Lt/t;->e0(Landroid/view/accessibility/AccessibilityNodeInfo;)Lt/t;

    move-result-object v0

    invoke-static {p1}, Landroidx/core/view/p0;->H(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lt/t;->a0(Z)V

    invoke-static {p1}, Landroidx/core/view/p0;->D(Landroid/view/View;)Z

    move-result v1

    invoke-virtual {v0, v1}, Lt/t;->Y(Z)V

    invoke-static {p1}, Landroidx/core/view/p0;->l(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lt/t;->Z(Ljava/lang/CharSequence;)V

    invoke-static {p1}, Landroidx/core/view/p0;->y(Landroid/view/View;)Ljava/lang/CharSequence;

    move-result-object v1

    invoke-virtual {v0, v1}, Lt/t;->c0(Ljava/lang/CharSequence;)V

    iget-object v1, p0, Landroidx/core/view/a$a;->a:Landroidx/core/view/a;

    invoke-virtual {v1, p1, v0}, Landroidx/core/view/a;->g(Landroid/view/View;Lt/t;)V

    invoke-virtual {p2}, Landroid/view/accessibility/AccessibilityNodeInfo;->getText()Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {v0, p2, p1}, Lt/t;->d(Ljava/lang/CharSequence;Landroid/view/View;)V
    ...
    check-cast v1, Lt/t$a;

    invoke-virtual {v0, v1}, Lt/t;->b(Lt/t$a;)V
