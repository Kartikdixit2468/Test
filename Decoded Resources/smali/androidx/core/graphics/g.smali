...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lr/g$b;I)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-virtual {p0, p3, p4}, Landroidx/core/graphics/j;->g([Lr/g$b;I)Lr/g$b;
    ...
    :try_start_0
    invoke-virtual {p3}, Lr/g$b;->d()Landroid/net/Uri;
    ...
    :cond_3
    invoke-static {p1, p3, p2}, Landroidx/core/graphics/k;->h(Landroid/content/Context;[Lr/g$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    ...
    invoke-virtual {v4}, Lr/g$b;->d()Landroid/net/Uri;
    ...
    :cond_5
    invoke-virtual {v4}, Lr/g$b;->c()I

    move-result v6

    invoke-virtual {v4}, Lr/g$b;->e()I

    move-result v7

    invoke-virtual {v4}, Lr/g$b;->f()Z
