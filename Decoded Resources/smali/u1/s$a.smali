...
# instance fields
.field final synthetic b:Lu1/s;


# direct methods
.method constructor <init>(Lu1/s;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lu1/s$a;->b:Lu1/s;
...
.method public onMethodCall(Lv1/i;Lv1/j$d;)V
    ...
    iget-object v1, p0, Lu1/s$a;->b:Lu1/s;

    invoke-static {v1}, Lu1/s;->a(Lu1/s;)Lu1/s$f;
    ...
    :pswitch_0
    iget-object p1, p0, Lu1/s$a;->b:Lu1/s;

    invoke-static {p1}, Lu1/s;->a(Lu1/s;)Lu1/s$f;

    move-result-object p1

    invoke-interface {p1}, Lu1/s$f;->f()V
    ...
    invoke-interface {p1}, Lu1/s$f;->b()V
    ...
    invoke-static {v0}, Lu1/s;->a(Lu1/s;)Lu1/s$f;
    ...
    invoke-interface {v0, p1}, Lu1/s$f;->h(Z)V
    ...
    invoke-interface/range {v5 .. v10}, Lu1/s$f;->e(DD[D)V
    ...
    invoke-interface {p1, v3, v4}, Lu1/s$f;->c(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    invoke-interface {p1}, Lu1/s$f;->a()V
    ...
    invoke-interface {p1}, Lu1/s$f;->i()V
    ...
    iget-object v3, p0, Lu1/s$a;->b:Lu1/s;

    invoke-static {v3}, Lu1/s;->a(Lu1/s;)Lu1/s$f;

    move-result-object v3

    invoke-static {p1}, Lu1/s$b;->a(Lorg/json/JSONObject;)Lu1/s$b;

    move-result-object p1

    invoke-interface {v3, v0, p1}, Lu1/s$f;->g(ILu1/s$b;)V
    ...
    invoke-interface {p2, v1, p1, v2}, Lv1/j$d;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p1}, Lu1/s$e;->a(Lorg/json/JSONObject;)Lu1/s$e;

    move-result-object p1

    invoke-interface {v0, p1}, Lu1/s$f;->j(Lu1/s$e;)V
    ...
    invoke-interface {v3, v0, p1}, Lu1/s$f;->d(IZ)V
