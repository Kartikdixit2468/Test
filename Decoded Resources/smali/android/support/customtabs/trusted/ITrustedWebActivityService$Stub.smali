...
.method public static asInterface(Landroid/os/IBinder;)Landroid/support/customtabs/trusted/ITrustedWebActivityService;
    ...
    :cond_0
    sget-object v0, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->f:Ljava/lang/String;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    invoke-interface {p0, p1, p4, p2}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->C(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/IBinder;)Landroid/os/Bundle;
    ...
    :pswitch_2
    invoke-interface {p0}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->d()Landroid/os/Bundle;
    ...
    invoke-interface {p0, p1}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->f(Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :pswitch_4
    invoke-interface {p0}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->m()Landroid/os/Bundle;
    ...
    :pswitch_5
    invoke-interface {p0}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->c()I
    ...
    invoke-interface {p0, p1}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->p(Landroid/os/Bundle;)V
    ...
    invoke-interface {p0, p1}, Landroid/support/customtabs/trusted/ITrustedWebActivityService;->r(Landroid/os/Bundle;)Landroid/os/Bundle;
