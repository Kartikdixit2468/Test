...
.method public constructor <init>(Landroidx/window/extensions/layout/WindowLayoutComponent;)V
    ...
    iput-object p1, p0, Ld1/e;->a:Landroidx/window/extensions/layout/WindowLayoutComponent;

    new-instance p1, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {p1}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    iput-object p1, p0, Ld1/e;->b:Ljava/util/concurrent/locks/ReentrantLock;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Ld1/e;->c:Ljava/util/Map;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, p0, Ld1/e;->d:Ljava/util/Map;
...
.method public a(Ls/a;)V
    ...
    iget-object v0, p0, Ld1/e;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-interface {v0}, Ljava/util/concurrent/locks/Lock;->lock()V

    :try_start_0
    iget-object v1, p0, Ld1/e;->d:Ljava/util/Map;
    ...
    :cond_0
    :try_start_1
    iget-object v2, p0, Ld1/e;->c:Ljava/util/Map;
    ...
    iget-object v3, p0, Ld1/e;->d:Ljava/util/Map;
    ...
    iget-object p1, p0, Ld1/e;->c:Ljava/util/Map;

    invoke-interface {p1, v1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    iget-object p1, p0, Ld1/e;->a:Landroidx/window/extensions/layout/WindowLayoutComponent;
...
.method public b(Landroid/content/Context;Ljava/util/concurrent/Executor;Ls/a;)V
    ...
    iget-object p2, p0, Ld1/e;->b:Ljava/util/concurrent/locks/ReentrantLock;
    ...
    iget-object v0, p0, Ld1/e;->d:Ljava/util/Map;
    ...
    iget-object p3, p0, Ld1/e;->a:Landroidx/window/extensions/layout/WindowLayoutComponent;
