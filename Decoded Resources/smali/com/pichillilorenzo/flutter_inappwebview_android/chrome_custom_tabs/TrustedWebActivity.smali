...
.method private prepareCustomTabs()V
    ...
    :cond_3
    iget-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->builder:Lm/c;

    invoke-virtual {v0}, Landroidx/browser/customtabs/a$a;->a()Landroidx/browser/customtabs/a;

    move-result-object v0

    invoke-virtual {v1, v0}, Lm/c;->c(Landroidx/browser/customtabs/a;)Lm/c;
    ...
    iget-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->builder:Lm/c;
    ...
    invoke-virtual {v0, v1}, Lm/c;->b(Ljava/util/List;)Lm/c;

    :cond_4
    iget-object v0, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/ChromeCustomTabsActivity;->customSettings:Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/ChromeCustomTabsSettings;

    iget-object v0, v0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/ChromeCustomTabsSettings;->displayMode:Lm/a;

    if-eqz v0, :cond_5

    iget-object v1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->builder:Lm/c;

    invoke-virtual {v1, v0}, Lm/c;->d(Lm/a;)Lm/c;
    ...
    invoke-virtual {v0, v1}, Lm/c;->e(I)Lm/c;

    return-void
.end method

.method private prepareCustomTabsIntent(Lm/b;)V
    .locals 1

    .line 1
    invoke-virtual {p1}, Lm/b;->a()Landroid/content/Intent;
...
.method public launchUrl(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/List;)V
    ...
    invoke-direct {p1, v3}, Lm/c;-><init>(Landroid/net/Uri;)V

    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->builder:Lm/c;
    ...
    iget-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->builder:Lm/c;
    ...
    invoke-virtual {p1, p4}, Lm/c;->a(Landroidx/browser/customtabs/i;)Lm/b;

    move-result-object v2

    invoke-direct {p0, v2}, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/TrustedWebActivity;->prepareCustomTabsIntent(Lm/b;)V
    ...
    invoke-static/range {v1 .. v6}, Lcom/pichillilorenzo/flutter_inappwebview_android/chrome_custom_tabs/CustomTabActivityHelper;->openTrustedWebActivity(Landroid/app/Activity;Lm/b;Landroid/net/Uri;Ljava/util/Map;Landroid/net/Uri;I)V
