...
.field public loader:Lw0/r;


# direct methods
.method public constructor <init>(Lw0/r;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lcom/pichillilorenzo/flutter_inappwebview_android/types/WebViewAssetLoaderExt;->loader:Lw0/r;
...
.method public static fromMap(Ljava/util/Map;Lcom/pichillilorenzo/flutter_inappwebview_android/InAppWebViewFlutterPlugin;Landroid/content/Context;)Lcom/pichillilorenzo/flutter_inappwebview_android/types/WebViewAssetLoaderExt;
    ...
    invoke-direct {v0}, Lw0/r$b;-><init>()V
    ...
    invoke-virtual {v0, v1}, Lw0/r$b;->c(Ljava/lang/String;)Lw0/r$b;
    ...
    invoke-virtual {v0, v1}, Lw0/r$b;->d(Z)Lw0/r$b;
    ...
    invoke-virtual {v0, v4, v2}, Lw0/r$b;->a(Ljava/lang/String;Lw0/r$d;)Lw0/r$b;
    ...
    new-instance v1, Lw0/r$c;

    invoke-direct {v1, p2, v2}, Lw0/r$c;-><init>(Landroid/content/Context;Ljava/io/File;)V

    goto :goto_2

    :pswitch_1
    new-instance v1, Lw0/r$a;

    invoke-direct {v1, p2}, Lw0/r$a;-><init>(Landroid/content/Context;)V

    :goto_2
    invoke-virtual {v0, v4, v1}, Lw0/r$b;->a(Ljava/lang/String;Lw0/r$d;)Lw0/r$b;

    goto/16 :goto_0

    :pswitch_2
    new-instance v1, Lw0/r$f;

    invoke-direct {v1, p2}, Lw0/r$f;-><init>(Landroid/content/Context;)V
    ...
    invoke-virtual {v0}, Lw0/r$b;->b()Lw0/r;

    move-result-object p1

    invoke-direct {p0, p1, v3}, Lcom/pichillilorenzo/flutter_inappwebview_android/types/WebViewAssetLoaderExt;-><init>(Lw0/r;Ljava/util/List;)V
