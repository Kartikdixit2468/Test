.class final enum Lio/flutter/view/h$i;
...
.field private static final synthetic H:[Lio/flutter/view/h$i;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lio/flutter/view/h$i;->b()[Lio/flutter/view/h$i;
...
.method private constructor <init>(Ljava/lang/String;II)V
    ...
    iput p3, p0, Lio/flutter/view/h$i;->e:I

    return-void
.end method

.method private static synthetic b()[Lio/flutter/view/h$i;
    .locals 28
    ...
    sget-object v2, Lio/flutter/view/h$i;->h:Lio/flutter/view/h$i;

    sget-object v3, Lio/flutter/view/h$i;->i:Lio/flutter/view/h$i;

    sget-object v4, Lio/flutter/view/h$i;->j:Lio/flutter/view/h$i;

    sget-object v5, Lio/flutter/view/h$i;->k:Lio/flutter/view/h$i;

    sget-object v6, Lio/flutter/view/h$i;->l:Lio/flutter/view/h$i;

    sget-object v7, Lio/flutter/view/h$i;->m:Lio/flutter/view/h$i;

    sget-object v8, Lio/flutter/view/h$i;->n:Lio/flutter/view/h$i;

    sget-object v9, Lio/flutter/view/h$i;->o:Lio/flutter/view/h$i;

    sget-object v10, Lio/flutter/view/h$i;->p:Lio/flutter/view/h$i;

    sget-object v11, Lio/flutter/view/h$i;->q:Lio/flutter/view/h$i;

    sget-object v12, Lio/flutter/view/h$i;->r:Lio/flutter/view/h$i;

    sget-object v13, Lio/flutter/view/h$i;->s:Lio/flutter/view/h$i;

    sget-object v14, Lio/flutter/view/h$i;->t:Lio/flutter/view/h$i;

    sget-object v15, Lio/flutter/view/h$i;->u:Lio/flutter/view/h$i;

    sget-object v16, Lio/flutter/view/h$i;->v:Lio/flutter/view/h$i;

    sget-object v17, Lio/flutter/view/h$i;->w:Lio/flutter/view/h$i;

    sget-object v18, Lio/flutter/view/h$i;->x:Lio/flutter/view/h$i;

    sget-object v19, Lio/flutter/view/h$i;->y:Lio/flutter/view/h$i;

    sget-object v20, Lio/flutter/view/h$i;->z:Lio/flutter/view/h$i;

    sget-object v21, Lio/flutter/view/h$i;->A:Lio/flutter/view/h$i;

    sget-object v22, Lio/flutter/view/h$i;->B:Lio/flutter/view/h$i;

    sget-object v23, Lio/flutter/view/h$i;->C:Lio/flutter/view/h$i;

    sget-object v24, Lio/flutter/view/h$i;->D:Lio/flutter/view/h$i;

    sget-object v25, Lio/flutter/view/h$i;->E:Lio/flutter/view/h$i;

    sget-object v26, Lio/flutter/view/h$i;->F:Lio/flutter/view/h$i;

    sget-object v27, Lio/flutter/view/h$i;->G:Lio/flutter/view/h$i;

    filled-new-array/range {v0 .. v27}, [Lio/flutter/view/h$i;
