...
.field private deferredComponentManager:Lo1/a;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Lm1/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ln1/f;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1, p2}, Ln1/f;->f(ILjava/nio/ByteBuffer;)V
...
.method private static synthetic lambda$decodeImage$0(JLandroid/graphics/ImageDecoder;Landroid/graphics/ImageDecoder$ImageInfo;Landroid/graphics/ImageDecoder$Source;)V
    ...
    invoke-static {p4}, Lio/flutter/embedding/android/n;->a(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lw1/d;
    ...
    :cond_4
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lw1/d;

    invoke-virtual {p1, v0}, Lw1/d;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Lm1/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/h$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, Lv1/o;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/h$g;->e:I
...
.method public getScaledFontSize(FI)F
    ...
    invoke-static {p2}, Lu1/p;->b(I)Landroid/util/DisplayMetrics;
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Ln1/f;->g(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public setDeferredComponentManager(Lo1/a;)V
    .locals 0
    ...
    invoke-interface {p1, p0}, Lo1/a;->a(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_0
    return-void
.end method

.method public setLocalizationPlugin(Lw1/d;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lw1/d;

    return-void
.end method

.method public setPlatformMessageHandler(Ln1/f;)V
    .locals 0

    .line 1
    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Ln1/f;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lc2/c;->a(ZLjava/lang/Object;)V
