.class Lio/flutter/plugin/editing/m;
...
# direct methods
.method public constructor <init>(Lu1/s$e;Landroid/view/View;)V
    .locals 2
    ...
    iput v0, p0, Lio/flutter/plugin/editing/m;->e:I

    iput v0, p0, Lio/flutter/plugin/editing/m;->f:I

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/m;->g:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/m;->h:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lio/flutter/plugin/editing/m;->i:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/m;->p:Landroid/view/inputmethod/BaseInputConnection;

    if-eqz p1, :cond_0

    invoke-virtual {p0, p1}, Lio/flutter/plugin/editing/m;->n(Lu1/s$e;)V

    :cond_0
    return-void
.end method

.method private j(Lio/flutter/plugin/editing/m$b;ZZZ)V
    .locals 1

    .line 1
    iget v0, p0, Lio/flutter/plugin/editing/m;->f:I
    ...
    iget p1, p0, Lio/flutter/plugin/editing/m;->f:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, Lio/flutter/plugin/editing/m;->f:I
...
.method private k(ZZZ)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->g:Ljava/util/ArrayList;
    ...
    invoke-direct {p0, v1, p1, p2, p3}, Lio/flutter/plugin/editing/m;->j(Lio/flutter/plugin/editing/m$b;ZZZ)V
...
.method public a(Lio/flutter/plugin/editing/m$b;)V
    ...
    :cond_0
    iget v0, p0, Lio/flutter/plugin/editing/m;->e:I
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->h:Ljava/util/ArrayList;
...
.method public b()V
    ...
    invoke-static {v0, v2}, Lm1/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/m;->k:Ljava/lang/String;

    invoke-virtual {p0}, Lio/flutter/plugin/editing/m;->i()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/m;->l:I

    invoke-virtual {p0}, Lio/flutter/plugin/editing/m;->h()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/m;->m:I

    invoke-virtual {p0}, Lio/flutter/plugin/editing/m;->g()I

    move-result v0

    iput v0, p0, Lio/flutter/plugin/editing/m;->n:I
...
.method public c()V
    ...
    .line 1
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->i:Ljava/util/ArrayList;
...
.method public d()V
    ...
    invoke-direct {p0, v3, v2, v2, v2}, Lio/flutter/plugin/editing/m;->j(Lio/flutter/plugin/editing/m$b;ZZZ)V
    ...
    iget-object v3, p0, Lio/flutter/plugin/editing/m;->g:Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/m;->k:Ljava/lang/String;
    ...
    iget v1, p0, Lio/flutter/plugin/editing/m;->l:I
    ...
    iget v1, p0, Lio/flutter/plugin/editing/m;->m:I
    ...
    :goto_2
    iget v3, p0, Lio/flutter/plugin/editing/m;->n:I
    ...
    iget v3, p0, Lio/flutter/plugin/editing/m;->o:I
    ...
    :cond_5
    invoke-direct {p0, v0, v1, v4}, Lio/flutter/plugin/editing/m;->k(ZZZ)V

    :cond_6
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->g:Ljava/util/ArrayList;

    iget-object v1, p0, Lio/flutter/plugin/editing/m;->h:Ljava/util/ArrayList;
...
.method public e()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lio/flutter/plugin/editing/m;->i:Ljava/util/ArrayList;
...
.method public m(II)V
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->p:Landroid/view/inputmethod/BaseInputConnection;
...
.method public n(Lu1/s$e;)V
    ...
    iget-object v1, p1, Lu1/s$e;->a:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lu1/s$e;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    iget v0, p1, Lu1/s$e;->b:I

    iget v1, p1, Lu1/s$e;->c:I
    ...
    :goto_0
    iget v0, p1, Lu1/s$e;->d:I

    iget p1, p1, Lu1/s$e;->e:I
...
.method public replace(IILjava/lang/CharSequence;II)Landroid/text/SpannableStringBuilder;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/m;->f:I
    ...
    invoke-static {v1, v2}, Lm1/b;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v1, v0, Lio/flutter/plugin/editing/m;->j:Ljava/lang/String;
    ...
    iget-object v8, v0, Lio/flutter/plugin/editing/m;->i:Ljava/util/ArrayList;
    ...
    iget v1, v0, Lio/flutter/plugin/editing/m;->e:I
    ...
    :goto_6
    invoke-direct {v0, v12, v1, v10}, Lio/flutter/plugin/editing/m;->k(ZZZ)V
...
.method public setSpan(Ljava/lang/Object;III)V
    ...
    iget-object p1, p0, Lio/flutter/plugin/editing/m;->i:Ljava/util/ArrayList;
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/plugin/editing/m;->j:Ljava/lang/String;
    ...
    iput-object v0, p0, Lio/flutter/plugin/editing/m;->j:Ljava/lang/String;
